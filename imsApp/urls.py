...
urlpatterns = [
    ...
    path('add-new-user', views.registerUser, name="register-user"),
    path('all-users', views.allUsers, name="all-user"),
    ...
    path('sales_invoice',views.render_pdf_view,name='sales-invoice'),
    # path('test',views.InvoiceListView.as_view(),name='test'),
    path('sales-invoice-pdf/<transaction>/',views.invoice_render_pdf_view,name='sales-invoice-pdf'),
